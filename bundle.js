...
/***/ function(module, exports, __webpack_require__) {
	...
	var globalObjects = __webpack_require__(5);
	var fileCrud = __webpack_require__(6);
	...
	var userFunc = __webpack_require__(30);
	...
	var crudActions = function crudActions() {
	...
	$(document).ready(function () {
	  ...
	  document.location.hostname === 'localhost' ? globalObjects.baseUrl = 'http://localhost:3000' : globalObjects.baseUrl = 'https://the-fridge-filebucket.herokuapp.com'; // set to our heroku app URL
...
/***/ function(module, exports, __webpack_require__) {
	...
	var globalObjects = __webpack_require__(5);
	var getFiles = __webpack_require__(7);

	var clearFiles = function clearFiles() {
	  $('.files-container').empty();
	};

	var createFile = function createFile(e) {
	...
	var updateFile = function updateFile(e) {
	  e.preventDefault();
	  var formData = new FormData(e.target);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var makeUnique = function makeUnique(folders) {
	...
	var displayFolders = function displayFolders(files) {
	  var foldersTemplate = __webpack_require__(8);
	  var folders = [];
	  ...
	  var foldersInfo = folders.map(function (folder) {
	    return { nospaces: folder.replace(/\s+/g, '-').replace(/[^a-zA-Z-]/g, ''), foldertext: folder };
	  });
	  $('.files-container').append(foldersTemplate({ foldersInfo: foldersInfo }));
	};
	...
	var displayFiles = function displayFiles(files) {
	  var filesTemplate = __webpack_require__(28);
	  files.forEach(function (file) {
	    if (file.folder === undefined) {
	    ...
	    $('.' + file.folder).append(filesTemplate({ file: file }));
	  });
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class=\"folders-and-files\">\n  <div class=\"folder-container\"><h4>"
	    + alias2(alias1((depth0 != null ? depth0.foldertext : depth0), depth0))
	    + "</h4>\n    <hr class=\"light\">\n    <div>\n      <table class=\"table table-striped\">\n        <thead>\n          <tr>\n            <th>Title</th>\n            <th>Description</th>\n            <th>Last Updated</th>\n            <th>Update File</th>\n            <th>Delete File</th>\n          </tr>\n        </thead>\n        <tbody class=\""
	    + alias2(alias1((depth0 != null ? depth0.nospaces : depth0), depth0))
	    + "\">\n        </tbody>\n      </table>\n    </div>\n  </div>\n</div>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.foldersInfo : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "    <tr>"
	    + ((stack1 = container.invokePartial(__webpack_require__(29),depth0,{"name":"file","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
	    + "</tr>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "\n  <td><a href=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.file : depth0)) != null ? stack1.location : stack1), depth0))
	    + "\" target=\"_blank\">"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.file : depth0)) != null ? stack1.title : stack1), depth0))
	    + "</a></td>\n  <td>"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.file : depth0)) != null ? stack1.description : stack1), depth0))
	    + "</td>\n  <td>"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.file : depth0)) != null ? stack1.updatedAt : stack1), depth0))
	    + "</td>\n  <td><button class=\"btn btn-primary btn-md update-file\" data-toggle=\"modal\" data-target=\"#updateFileModal\" data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.file : depth0)) != null ? stack1._id : stack1), depth0))
	    + "\">Update</button></td>\n  <td><button class=\"btn btn-primary btn-md delete-file\" data-toggle=\"modal\" data-target=\"#deleteFileModal\" data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.file : depth0)) != null ? stack1._id : stack1), depth0))
	    + "\" id=\"delete-file\">Delete</button></td>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var assignUserData = function assignUserData(data) {
